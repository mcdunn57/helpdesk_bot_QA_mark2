...
def load_vector_store():
    """Loads or creates the FAISS vector store, persisting it to disk."""
    FAISS_INDEX_PATH = "faiss_index"
    
    # Define the data for the helpdesk bot and ensure CSV is created/updated.
    # This guarantees 'Helpdesk_bot_QA.csv' exists before being read for FAISS creation.
    csv_data = {
        'Question': [
    ...
    print("Ensured 'Helpdesk_bot_QA.csv' exists with sample data.")
    ...
    if os.path.exists(FAISS_INDEX_PATH):
        ...
        # The CSV file is guaranteed to exist now because of the code above.
